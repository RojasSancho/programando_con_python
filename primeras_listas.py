...
#1 - Devolver elementos de la listade
...
#3 - Devuelve el indice donde se encuentra el elemento dado
print(mi_lista.index("Dilan")) 

#4 - Verificar si un elemento pertenece o esta en una lista (Boolean)
...
#6 - Unir dos lista diferentes
mi_lista2 = [2, 3, 4, 5]
listas_unidas = mi_lista + mi_lista2 #Operador de suma

print(listas_unidas[:]) 

#7 - Repetidor (hacer una lista repitiendo una serie de elementos)  
